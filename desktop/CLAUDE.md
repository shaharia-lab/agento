...
macOS, `.msi` + NSIS `.exe` on Windows. The release workflow builds all four
target triples on their own runners and attaches the installers to a draft
release.
...
**The Claude Code CLI is a genuine external dependency and is not bundled.**
