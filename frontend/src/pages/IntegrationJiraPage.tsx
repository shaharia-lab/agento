...
import JiraIntegrationEditor from '@/components/integrations/JiraIntegrationEditor'
...
export default function IntegrationJiraPage() {
  ...
  const [services, setServices] = useState<Record<string, ServiceConfig>>({
    project_management: { enabled: false, tools: [] },
  })
      ...
      <div className="flex-1 overflow-y-auto p-4 sm:p-6">
        ...
        {step === 1 && (
          <div>
            ...
            <div className="space-y-4 max-w-lg">
              <div>
                <label
                  htmlFor="jira-integration-name"
                  className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1"
                >
                  Integration name
                </label>
                <input
                  id="jira-integration-name"
                  type="text"
                  value={name}
              ...
              <div>
                ...
                <p className="text-xs text-zinc-400 mt-1">
                  Your Atlassian Cloud URL, e.g. https://yoursite.atlassian.net
                </p>
              </div>
              <div>
                <label
            ...
            <div className="flex justify-end mt-6">
              <button
                onClick={() => setStep(2)}
                disabled={!name || !siteUrl || !email || !apiToken}
        ...
        {step === 2 && (
          <div>
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-4">
              Choose which Jira tools agents can access.
            </p>

            <JiraIntegrationEditor services={services} onServicesChange={setServices} />
            ...
            {validating && (
              <>
                ...
                <p className="text-sm text-zinc-500 dark:text-zinc-400">
                  Connecting to Jira API to verify your credentials.
                </p>
              </>
            )}
            ...
            {!validating && validated && (
              <>
                ...
                <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-6">
                  Your Jira integration is ready. You can now assign its tools to agents.
                </p>
