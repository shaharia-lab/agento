  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Left tab sidebar */}
        <nav className="w-40 shrink-0 border-r border-zinc-100 py-3 px-2">
          <button className="flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm bg-zinc-900 text-white">
            General
          </button>
        </nav>
